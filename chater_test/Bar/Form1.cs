    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string CipherTtoPlainT(string cipherT)
            {
                ...
                {
                    int p = i/2 - cipherT_Data.Length/4+1;
                    if (p < 0 )
                    {
                        p = p + cipherT_Data.Length / 2;
                    }
                    plainT_Data[p] = Convert.ToByte(cipherT_Data[i] - p  );
                    if (plainT_Data[p] < 33)
                    {
                        plainT_Data[p] = Convert.ToByte(plainT_Data[p] + 126 - 32);
                    }
                }
